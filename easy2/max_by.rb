...
# input: Array
# output: element from array for which the block returned the largest value

# algo:
#   init largest to nil
#   iterate: pass each element to block 
#   if largest is nil or blocks return value is greater than largest, largest == blocks return value
